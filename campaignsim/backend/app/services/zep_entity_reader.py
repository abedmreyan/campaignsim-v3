...
logger = get_logger('campaignsim.zep_entity_reader')
...
class ZepEntityReader:
        ...
        for attempt in range(max_retries):
            try:
                ...
                if attempt < max_retries - 1:
                    ...
                    logger.error(f"Zep {operation_name} after {max_retries} attempts, still failing: {str(e)}")
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Retrieved {len(edges_data)} ")
        return edges_data
