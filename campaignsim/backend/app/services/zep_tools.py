...
logger = get_logger('campaignsim.zep_tools')
...
class InsightForgeResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"\n### ",
            f"- Fact: {self.total_facts}",
            f"- Entity: {self.total_entities}",
        ...
        if self.entity_insights:
            ...
            for entity in self.entity_insights:
                ...
                if entity.get('related_facts'):
                    text_parts.append(f" Fact: {len(entity.get('related_facts', []))}")
...
class PanoramaResult:
    ...
    def to_text(self) -> str:
        ...
        text_parts = [
            ...
            f"- : {self.total_nodes}",
            f"- : {self.total_edges}",
            f"- Fact: {self.active_count}",
            f"- / Fact: {self.historical_count}"
        ]
    ...
    def interview_agents(
        ...
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Extract meaningful sentences (method 1: split on sentence-ending punctuation)
                ...
                # Extract meaningful sentences (method 2: quoted phrases)
                if not key_quotes:
            ...
            result.summary = f"{str(e)}OASIS after "
            return result
        except Exception as e:
