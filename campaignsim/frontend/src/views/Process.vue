<template>
  <div class="process-page">
    ...
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">CAMPAIGNSIM</div>
      ...
      <div class="right-panel" :class="{ 'hidden': isFullScreen }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes the content and auto-generates an ontology structure (entity types + relation types).
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and sent to the Zep API to build the knowledge graph, extracting entities and relations.
                </div>
              </div>
              ...
              <div class="detail-section" v-if="graphData">
                ...
                <div class="build-result">
                  <div class="result-item">
                    ...
                    <span class="result-label">Entities</span>
                  </div>
                  <div class="result-item">
                    <span class="result-value">{{ graphData.edge_count }}</span>
                    <span class="result-label">Relations</span>
                  </div>
                  <div class="result-item">
        ...
        <div class="project-panel">
          ...
          <div class="project-details" v-if="projectData">
            ...
            <div class="project-item">
              <span class="item-label">Campaign Goal</span>
...
const currentPhase = ref(-1) // -1: , 0: , 1: , 2: 
...
//  -  ontology/generate API
const handleNewProject = async () => {
  const pending = getPendingUpload()
  
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No files pending. Please return to the home page and try again.'
    loading.value = false
    return
  }
